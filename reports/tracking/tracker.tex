...
Incorrect Mask (Class 0) & 3.524 & 754 & 722 & 5.000 \\ \hline
With Mask (Class 1)      & 3.367 & 734 & 688 & 4.789 \\ \hline
Without Mask (Class 2)   & 3.284 & 692 & 771 & 4.747 \\ \hline
\textbf{Tổng}            & \textbf{10.175} & \textbf{2.180} & \textbf{2.181} & \textbf{14.536} \\ \hline
\end{tabularx}
\end{table}

Để hạn chế hiện tượng mất cân bằng dữ liệu giữa các lớp, hệ thống sử dụng hàm \texttt{limit\_dataset\_per\_class()} nhằm giới hạn số lượng ảnh tối đa của mỗi lớp. Trong quá trình thực nghiệm, giá trị \texttt{max\_per\_class} được thiết lập bằng 5.000. Nếu số lượng ảnh của một lớp vượt quá ngưỡng này, các mẫu sẽ được lựa chọn ngẫu nhiên (\textit{Random Sampling}) để đảm bảo sự cân bằng tương đối giữa các lớp dữ liệu.
...
Saturation = 0.2
&
Mô phỏng các điều kiện ánh sáng khác nhau trong thực tế.
\\ \hline
...
\begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/chitietsoluong.png}
    \caption{Thống kê số lượng ảnh của từng lớp}
\end{subfigure}
\hfill
\begin{subfigure}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/trucquan_dataset.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/report_adam.png}
